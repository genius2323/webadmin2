    ...
    <div class="content-card">
        ...
        <form action="<?= site_url('masterkategori/store') ?>" method="post" autocomplete="off">
            <div class="form-group">
                <label for="kode_cat" class="form-label">Kode Kategori<span style="color:red">*</span></label>
                <input type="text" name="kode_cat" id="kode_cat" class="form-m3-input input-m3-date" required maxlength="4" pattern="[A-Za-z0-9]{1,4}" title="Maksimal 4 karakter huruf/angka" placeholder="Kode Kategori">
            </div>
            <div class="form-group">
                <label for="name" class="form-label">Nama Kategori<span style="color:red">*</span></label>
                <input type="text" name="name" id="name" class="form-m3-input input-m3-date" required placeholder="Nama Kategori">
            </div>
            <div class="form-group">
            ...
            <div class="form-actions" style="display:flex;justify-content:flex-end;margin-top:32px;gap:10px;">
                ...
                <a href="<?= site_url('masterkategori') ?>" class="btn-logout-modern" style="background:#e53935;color:#fff;">Batal</a>
            </div>
        </form>
    </div>
</div>
