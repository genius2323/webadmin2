...
<div class="page-header-modern">
    <div>
        <h2 class="page-title">Master Dimensi</h2>
        <div class="page-subtitle">Daftar seluruh data dimensi.</div>
    </div>
    <a href="<?= site_url('masterdimensi/create') ?>" class="btn-modern btn-primary-modern">
                ...
                <?php foreach ($dimensi as $row): ?>
                    ...
                    <tr>
                        ...
                        <td style="min-width:70px;display:flex;gap:6px;justify-content:center;align-items:center;">
                            <a href="<?= site_url('masterdimensi/edit/' . $row['id']) ?>" class="btn-modern btn-warning-modern" title="Edit"
                            ...
                            <a href="<?= site_url('masterdimensi/delete/' . $row['id']) ?>" class="btn-modern btn-danger-modern" title="Hapus"
                                <?php if (empty($row['otoritas']) || $row['otoritas'] !== 'T'): ?>disabled style="pointer-events:none;opacity:0.6;" <?php endif; ?>
