...
<div class="page-header-modern">
    <div>
        <h2 class="page-title">Master Satuan</h2>
        <div class="page-subtitle">Daftar seluruh data satuan.</div>
    </div>
    <a href="<?= site_url('mastersatuan/create') ?>" class="btn-modern btn-primary-modern">
            ...
            <tbody>
                <?php foreach ($satuan as $row): ?>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= isset($row['description']) ? esc($row['description']) : '-' ?></td>
                        ...
                        <td style="min-width:70px;display:flex;gap:6px;justify-content:center;align-items:center;">
                            <a href="<?= site_url('mastersatuan/edit/' . $row['id']) ?>" class="btn-modern btn-warning-modern" title="Edit"
                            ...
                            <a href="<?= site_url('mastersatuan/delete/' . $row['id']) ?>" class="btn-modern btn-danger-modern" title="Hapus"
                                <?php if (empty($row['otoritas']) || $row['otoritas'] !== 'T'): ?>disabled style="pointer-events:none;opacity:0.6;" <?php endif; ?>
