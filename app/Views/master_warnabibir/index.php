...
<div class="page-header-modern">
    <div>
        <h2 class="page-title">Master Warna Bibir</h2>
        <div class="page-subtitle">Daftar seluruh data warna bibir.</div>
    </div>
    <a href="<?= base_url('masterwarnabibir/create') ?>" class="btn-modern btn-primary-modern">
        <svg width="18" height="18" fill="none" viewBox="0 0 24 24">
            <path d="M12 5v14m7-7H5" stroke="#fff" stroke-width="2" stroke-linecap="round" />
        </svg> Tambah Warna Bibir
    </a>
</div>
                ...
                <?php foreach ($warnabibir as $row): ?>
                    ...
                    <tr>
                        ...
                        <td style="min-width:70px;display:flex;gap:6px;justify-content:center;align-items:center;">
                            <a href="<?= site_url('masterwarnabibir/edit/' . $row['id']) ?>" class="btn-modern btn-warning-modern" title="Edit"
                            ...
                            <a href="<?= site_url('masterwarnabibir/delete/' . $row['id']) ?>" class="btn-modern btn-danger-modern" title="Hapus"
                                <?php if (empty($row['otoritas']) || $row['otoritas'] !== 'T'): ?>disabled style="pointer-events:none;opacity:0.6;" <?php endif; ?>
